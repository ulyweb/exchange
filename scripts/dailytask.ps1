...
.DESCRIPTION
    ...
    3.  Checks if the 'PowerShellGet' and 'ExchangeOnlineManagement' modules are installed.
        - If 'ExchangeOnlineManagement' is missing, it will install it from the PowerShell Gallery.
...
# =========================================================================
# Step 2: Set Execution Policy to RemoteSigned
# =========================================================================
...
if (-not (Get-Module -Name $moduleName -ListAvailable)) {
    ...
    Install-Module -Name $moduleName -Force -Scope AllUsers -Confirm:$false
    ...
    try {
        ...
        if ($latestVersion -and ($latestVersion -gt $installedVersion)) {
            ...
            Update-Module -Name $moduleName -Force -Scope AllUsers -Confirm:$false -ErrorAction Stop
...
try {
    ...
    # This is more reliable than checking for a PSSession name.
    ...
    # Ensure the module is loaded before we try to connect.
